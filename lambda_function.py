...
def recommend_portfolio(intent_request):
    ...
    # Validate that the user is over 0 and under 65 years old
    if age is not None:
        if parse_int(age) < 0 or parse_int(age) > 65:
            return build_validation_result(
                False,
                "birthday",
                "You should be under 65 years old and above 0 years old to use this service, "
